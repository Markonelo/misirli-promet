    ...
    <>
      ...
      <section className="bg-bg pt-[104px] md:pt-[128px]">
        <div className="container-wide">
          ...
          <Reveal delay={0.1}>
            <div className="relative mt-10 aspect-[4/3] w-full overflow-hidden rounded-[1.75rem] border border-line bg-gradient-to-br from-[#11233F] to-[#0E1219] sm:aspect-[3/2] lg:aspect-[16/10]">
